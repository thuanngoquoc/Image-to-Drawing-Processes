...
class MainWindow(QMainWindow):
    def __init__(self, priority_map=None, dataset_slug="thuanngoquoc/inputdata"):
        ...
        if priority_map is None:
            priority_map = {
                ...
                #"car": ["car", "wheel", "window", "light", "background"],
    ...
    def color_next_pixels(self):
        ...
        batch_size = 300  # Number of pixels to color in each batch
    ...
    # Ensure this runs smoothly on button press
    def on_fill_color_button_clicked(self):
        self.fill_color()
